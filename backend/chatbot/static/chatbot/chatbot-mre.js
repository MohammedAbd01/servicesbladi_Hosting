...
class ChatbotMRE {
    ...
    createMessageElement(content, type) {
        ...
        if (type === 'user') {
            ...
            // Create cartoon avatar for bot
            const cartoonAvatar = document.createElement('div');
            cartoonAvatar.className = 'cartoon-avatar-small';
            cartoonAvatar.innerHTML = `
            ...
            `;
            avatarDiv.appendChild(cartoonAvatar);
        }
    ...
    processMessageContent(content, type) {
        ...
        // Remplacer les émojis de drapeaux par le composant flag
        processed = processed.replace(/🇲🇦/g, '<span class="morocco-flag"></span>');
